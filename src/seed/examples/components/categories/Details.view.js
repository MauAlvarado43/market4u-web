...
const CategoryDetailsView = ({ category, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${category.id}/edit`} class="btn btn-secondary mr-2">Edit category</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete category</button>
      </div>
    </div>
  </div>;
