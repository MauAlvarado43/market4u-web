...
const SaleDetailsView = ({ sale, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${sale.id}/edit`} class="btn btn-secondary mr-2">Edit sale</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete sale</button>
      </div>
    </div>
  </div>;
