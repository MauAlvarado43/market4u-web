...
const CompanyDetailsView = ({ company, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${company.id}/edit`} class="btn btn-secondary mr-2">Edit company</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete company</button>
      </div>
    </div>
  </div>;
