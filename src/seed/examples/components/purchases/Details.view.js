...
const PurchaseDetailsView = ({ purchase, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${purchase.id}/edit`} class="btn btn-secondary mr-2">Edit purchase</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete purchase</button>
      </div>
    </div>
  </div>;
