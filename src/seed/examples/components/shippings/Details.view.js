...
const ShippingDetailsView = ({ shipping, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${shipping.id}/edit`} class="btn btn-secondary mr-2">Edit shipping</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete shipping</button>
      </div>
    </div>
  </div>;

ShippingDetailsView.propTypes = {
