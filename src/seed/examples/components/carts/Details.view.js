...
const CartDetailsView = ({ cart, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${cart.id}/edit`} class="btn btn-secondary mr-2">Edit cart</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete cart</button>
      </div>
    </div>
  </div>;
