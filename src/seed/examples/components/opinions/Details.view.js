...
const OpinionDetailsView = ({ opinion, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${opinion.id}/edit`} class="btn btn-secondary mr-2">Edit opinion</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete opinion</button>
      </div>
    </div>
  </div>;

OpinionDetailsView.propTypes = {
  opinion: PropTypes.object.isRequired,
  onClickDelete: PropTypes.func
};

export default OpinionDetailsView;