...
const VariantDetailsView = ({ variant, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${variant.id}/edit`} class="btn btn-secondary mr-2">Edit variant</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete variant</button>
      </div>
    </div>
  </div>;

VariantDetailsView.propTypes = {
