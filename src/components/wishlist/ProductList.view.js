...
const ProductListView = () => (
  <div>
    <table
      class="table table-borderless table-nowrap table-align-middle card-table dataTable no-footer"
      role="grid"
        ...
        >
          <th class="text-center">
            <img
              ...
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsBnmlNdzywUBubkfIMgX_5VF6vqlPAr3aIQ&usqp=CAU"
            ></img>
          </th>
