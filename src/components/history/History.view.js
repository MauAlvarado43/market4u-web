...
const HistoryView = () => (
  ...
  <div className="history-container">
    ...
    <div className="history-search">Buscar</div>

    <div className="history-filter">Filtrar</div>

    <div className="history-cart">
      {carts &&
        carts.users[0].buyerCarts[0].shippings.map((shipping, index) => (
          <div>
            <div className="history-shipping">
              ...
              <div className="history-shipping-order">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      **** **** ****{" "}
                      {carts.users[0].buyerCarts[0].payment.cardNumber.slice(
                        12,
                        16
                      )}
                    </td>
              ...
              <div className="history-shipping-buttons">
                <button
                  style={{
                    "--bg-color-shop": "#519EA4",
                    "--bg-color-hover": "#6ad2d9",
                    "--bg-color-active": "#366a6e",
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  style={{
                    "--bg-color-shop": "#fa6400",
                    "--bg-color-hover": "#fb8332",
                    "--bg-color-active": "#c85000",
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
