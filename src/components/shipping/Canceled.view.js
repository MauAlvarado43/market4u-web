...
const CanceledView = ({ onClickCanceled = () => null, onClose = () => null }) =>
    <div class="card card-body">
        <div className="row mt-2">
            <div className="col-md-12 text-center">
                <h2>¿Desea cancelar el envío?</h2>
            </div>
        </div>
        <div className="row my-2">
            <div className="col-md-12 text-center">
                <p className="h4">
                    Si elige cambiar, se cancelará el envío
                </p>
            </div>
        </div>
        <div className="row">
...
CanceledView.propTypes = { // Establece el tipo de dato de las propiedades
};
